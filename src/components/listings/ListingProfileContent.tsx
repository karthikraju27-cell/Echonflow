...
// Shared between the signed-in seeker listing page (/seeker/directory/[id])
// and the fully public provider profile (/p/provider/[id]) — identical
// content either way, the only difference is whether a seekerId is known.
export function ListingProfileContent({
  listing,
  seekerId,
  seekerName,
  seekerEmail,
